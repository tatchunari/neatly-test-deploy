...
//     });
//   const moneyWithCurrency = (n: number) => `${booking.currency} ${money(n)}`;
...
//             className="w-full h-[220px] sm:h-[260px] md:h-[210px] object-cover rounded-[8px] mb-[20px] md:mb-0 md:w-[357px] md:[grid-row:1/4] md:[grid-column:1/2]"
//           />
...
//               type="button"
//               onClick={() => setOpen((v) => !v)}
//               className="mt-[24px] md:mt-[32px] w-full flex items-center justify-between bg-gray-200 px-4 sm:px-5 py-3 text-[16px] sm:text-[16px] font-inter font-semibold text-gray-00 hover:bg-gray-100"
//               aria-expanded={open}
//             >
...
//                 Room Detail
//               </Link>
//               <button className="inline-flex h-11 w-full items-center justify-center rounded-md bg-orange-600 font-semibold font-inter px-4 text-[16px] text-white hover:brightness-110">
//                 Change Date
//               </button>
//             </div>
...
//               <button className="text-[16px] font-inter font-semibold text-orange-500 hover:underline">
//                 Cancel Booking
//               </button>
//             </div>
//           </div>
...
//             <button className="text-[16px] text-orange-500 font-semibold font-inter hover:underline cursor-pointer">
//               Cancel Booking
//             </button>
...
//                 Room Detail
//               </Link>
//               <button className="rounded-md bg-orange-600 text-white px-5 py-2 text-[16px] font-semibold font-inter cursor-pointer hover:brightness-110">
//                 Change Date
//               </button>
//             </div>
//           </div>
